...
O programa compara o risco do primeiro ciclo com o risco do último para informar se a missão melhorou, piorou ou permaneceu estável.

Também soma os pontos de cada área durante todos os ciclos. A área que tiver a maior pontuação acumulada é apresentada como a mais afetada.

O risco médio é calculado com as pontuações dos ciclos. Para a classificação final são usadas as mesmas faixas da classificação de cada ciclo.
